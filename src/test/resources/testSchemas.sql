...
CREATE INDEX IF NOT EXISTS idx_prestamos_activos ON prestamos(user_id, estado);
CREATE INDEX IF NOT EXISTS idx_libros_disponibles ON libros(disponibles, eliminado);